...
if(length(completed_4545) > 0){
  completed_4545 <- completed_4545 %>% 
    ...
    str_remove_all("\\.html") %>% 
    sort(decreasing = T) %>% 
    paste0("[Season ", ., "]", "(https://lichess4545stats.github.io/docs/reports/stats_4545_s", ., ".html)")
}
...
if(length(completed_lwopen) > 0){
  completed_lwopen <- completed_lwopen %>% 
    ...
    str_remove_all("\\.html") %>% 
    sort(decreasing = T) %>% 
    paste0("[Season ", ., "]", "(https://lichess4545stats.github.io/docs/reports/stats_lwopen_s", ., ".html)")
}
...
if(length(completed_lwu1800) > 0){
 completed_lwu1800 <- completed_lwu1800 %>%  
   ...
   str_remove_all("\\.html") %>% 
   sort(decreasing = T) %>% 
   paste0("[Season ", ., "]", "(https://lichess4545stats.github.io/docs/reports/stats_lwu1800_s", ., ".html)")
}
...
if(length(completed_960) > 0){
 completed_960 <- completed_960 %>%  
   ...
   str_remove_all("\\.html") %>% 
   sort(decreasing = T) %>% 
   paste0("[Season ", ., "]", "(https://lichess4545stats.github.io/docs/reports/stats_chess960_s", ., ".html)")
}
...
- [4545 / Team](https://lichess4545stats.github.io/docs/pgns/allgames_team4545.pgn) (44,799 games, seasons 2-44, played 2015-10-27 to 2025-07-07)
- [LoneWolf (Open)](https://lichess4545stats.github.io/docs/pgns/allgames_lwopen.pgn) (20,413 games, seasons 1-36, played 2015-11-17 to 2025-05-05)
- [LoneWolf (U1800)](https://lichess4545stats.github.io/docs/pgns/allgames_lwu1800.pgn) (9,193 games, seasons 9-36, played 2017-11-14 to 2025-05-05)
- [Chess960](https://lichess4545stats.github.io/docs/pgns/allgames_chess960.pgn) (3,010 games, seasons 2-36, played 2018-6-11 to 2025-07-27)

*Community leagues*

- [Series](https://lichess4545stats.github.io/docs/pgns/allgames_series.pgn) (90+30) - 4,390 games, S1 (Nov 2017) to S28 (Dec 2024 - Feb 2025)
- [Rapid Battle](https://lichess4545stats.github.io/docs/pgns/allgames_rb.pgn) (15+10) - recorded games up to Nov 2022
- [Quest](https://lichess4545stats.github.io/docs/pgns/allgames_quest.pgn) (15+10) - includes recorded games played up to Nov 2022

*Combined - classical leagues*

- [4545 + LoneWolf + Series](https://lichess4545stats.github.io/docs/pgns/allgames_teamlwseries.pgn) (75,366 games, last updated 2025-03-25)

### Notes

- Many result-based stats are based on Lichess game data and therefore do not account for forfeits and unplayed games.
- The chart showing the positions of the top 5 teams each season ([example](https://lichess4545stats.github.io/docs/reports/stats_4545_s29.html#How_the_title_race_played_out)) is retroactively calculated so it doesn't necessarily capture positions at the time of each round and it won't show how any Lichess fair play decisions might have affected the standings.
